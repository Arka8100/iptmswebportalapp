					...
					<div class="col-12 col-md-6 my-3">
						<div class="container bg-white shadow-lg roundedc">
							...
							<div class="d-flex align-items-center py-3 px-2">
								<img class="img-fluid "
									src="https://i.ibb.co/MfDVX5t/bg-treatment.png" alt=""
									style="height: 210px;">
								<div>
									<div class="item-text">Ailment : ${p.ailmentCategory}</div>
									<div class="subtext">Package : ${p.packageDetail.treatmentPackageName}</div>
									<div class="subtext">Test Detail : ${p.packageDetail.testDetails}</div>
									<div class="subtext">Cost in Rupees : ${p.packageDetail.cost}</div>
									<div class="subtext">Duration in Weeks : ${p.packageDetail.treatmentDurationInWeeks}</div>
