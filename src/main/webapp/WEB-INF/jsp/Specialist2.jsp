    ...
    <div class="container text-center pt-5">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-4">
                <p class="display-4"> Specialists </p>
            </div>
            <div class="col-md-4">
                <hr style="border: 1px solid rgb(80, 80, 80);">
            </div>
            ...
            <c:forEach items="${specialist}" var="spec">
                ...
                <div class="container bg-white shadow-lg roundedc">
                        ...
                        <div class="d-flex align-items-center py-3 px-2">
                            <img class="img-fluid " src="https://i.ibb.co/99Ztz62/bg-doctor.png" alt="" style="height: 240px;">
                            <div>
                                <div class="item-text">Specialist's Name  :  ${spec.name} </div>
                                <div class="subtext">Area of Expertise  : ${spec.areaOfExpertise}</div>
                                <div class="subtext">Having Experience of  : ${spec.experienceInYears} Years.</div>
                                <div class="subtext">Contact Number  :  ${spec.contactNumber}</div>
                            </div>
                        </div>
